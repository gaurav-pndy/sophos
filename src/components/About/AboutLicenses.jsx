...
const AboutLicenses = () => {
  ...
  const documents = [
    ...
    },
    {
      ...
      url: "/docs/licenses/Информация о страховых медицинских организациях, с которыми заключены.pdf",
    },
    {
      id: 4,
    ...
    },
    {
      ...
      url: "/docs/licenses/Информация о показателях доступности и качества медицинской.pdf",
    },
    {
      id: 11,
    ...
    },
    {
      ...
      url: "/docs/licenses/Информация о перечне оказываемых платных медицинских услуг, о ценах (тарифах) на медицинские услуги.pdf",
    },
    {
      id: 18,
