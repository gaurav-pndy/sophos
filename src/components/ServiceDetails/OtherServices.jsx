    ...
    <div className="bg-white rounded-2xl shadow p-8">
      <div className="grid  grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {services.map((service, index) => (
          ...
          >
            <div className="w-14 h-14 rounded-full from-[#3a4660] to-[#845007] flex items-center justify-center shrink-0 group-hover:rotate-15 bg-gradient-to-br group-hover:from-brand2 group-hover:to-brand1 transition-all duration-300 group-hover:scale-110">
              <img
                src={service.image}
                alt={t(service.title)}
