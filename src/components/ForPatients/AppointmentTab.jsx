...
const AppointmentTab = ({ t }) => {
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
            ...
            <a
              ...
              className="text-brand3 font-bold text-xl hover:text-brand1 transition-colors block mb-3"
            >
              +7 (499) 685 3000
            </a>
            ...
            <button 
              ...
              className="bg-brand3 text-white px-6 py-3 rounded-lg font-semibold hover:bg-brand1 transition-colors w-full mt-2"
            >
  ...
  <span className="font-bold">
    <a href="/for-patients#appointment" className="text-brand3 hover:text-brand1 transition-colors">
      Оставьте заявку
    </a>
  </span> в форме обратной связи, и мы свяжемся с вами.
</p>
